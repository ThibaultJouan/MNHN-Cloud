      ...
      <div class="row">
        <div class = 'col-md-2'>
          <button type="submit" form="formProject" class="btn btn-success"
			      href="../../service/admin/edit_project_bdd.php">Mise a jour</button>
        </div>
        <div class = 'col-md-2'>
          <button type="submit" form="formProject2User" class="btn btn-success"
			      href="./update/edit_project2user.php">Ajouter utilisateurs</button>
        </div>
        <div class = 'col-md-2'>
          <button type="submit" form="formProject2Experience" class="btn btn-success"
			      href="./update/edit_project2experience.php">Ajouter experiences</button>
        </div>
        <div class = 'col-md-2'>
          <p>
